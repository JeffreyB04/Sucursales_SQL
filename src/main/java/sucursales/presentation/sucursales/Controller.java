...
public class Controller {
    ...
    public void editar(int row){
        ...
        Sucursal s =null;
        try {
            s = Service.instance().sucursalGet(codigo);
    ...
    public void obtieneSelected(int row){

        model.selected = model.getSucursales().get(row);
        model.getSucursales().set(row,model.selected);
        view.Components();
    }
    ...
    public void show() {
        ...
        Application.window.setLayout(null);
    }
    ...
    public void imprimir()throws Exception{
        ...
        header.addCell(getCell(new Image(ImageDataFactory.create("src/main/java/sucursales/image/SISEpdf.jpeg")), HorizontalAlignment.CENTER,false));
        document.add(header);
